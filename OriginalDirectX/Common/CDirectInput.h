...
class CDirectInput
{
	...
	LPDIRECTINPUTDEVICE8	m_pController;	// コントローラー
	DIDEVCAPS				m_devCaps;
	...
	DIJOYSTATE m_controllerButton;			// コントローラーの入力情報
	DIJOYSTATE m_controllerButtonPrev;		// 前回のコントローラーの入力情報
	FLOAT m_lXValue;						// アナログスティックのx軸
	FLOAT m_lYValue;						// アナログスティックのy軸
